...
#                                                                             
# PROGRAMMER: Salle-Njume Brian Salle
...
def adjust_results4_isadog(results, dogfile):
    ...
    """           
     ...
     # Create dognames dictionary for quick lookup
    dognames_dic = {}
    ...
    # Check if pet labels and classifier labels are dogs
    for key in results:
        pet_label = results[key][0] 
        class_label = results[key][1]
        ...
        if pet_label in dognames_dic:
            ...
            #                              
            if class_label in dognames_dic:
                # 4c. Append (1, 1) 
